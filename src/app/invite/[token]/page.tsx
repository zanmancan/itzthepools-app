...
/**
 * Accept an invite token and redirect into the league.
 * If not signed in, send to /login and then return here.
 */
  ...
  if (error) {
    return (
      <div className="container mx-auto max-w-xl p-6">
        ...
        <div className="mt-4">
          <a className="px-4 py-2 rounded bg-gray-700 text-white" href="/dashboard">
            Back to dashboard
          </a>
        </div>
      </div>
